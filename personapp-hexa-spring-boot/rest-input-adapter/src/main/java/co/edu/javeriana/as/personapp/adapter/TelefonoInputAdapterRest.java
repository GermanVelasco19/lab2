...
public class TelefonoInputAdapterRest {
    ...
    public TelefonoResponse crearTelefono(@Valid TelefonoRequest request){
        try{
            ...
            val person = outputPerson.findOne(request.getDuenio());
    ...
    public TelefonoResponse editTelefono(TelefonoRequest request){
        try{
            ...
            val outputPerson = outputPersonPortFactory.getPersonOutputPort(request.getDatabase());
            val person = outputPerson.findOne(request.getDuenio());
            val res = outputPhone.edit(String.valueOf(request.getNum()), phoneMapperRest.fromAdapterToDomain(request, person));
    ...
    public Boolean deleteTelefono(@Valid DeleteTelefonoRequest request){
        try{
            val outputPhone = outputPhonePortFactory.getPhoneOutputPort(request.getDatabase());
    ...
    public TelefonoResponse getOnePerson(@Valid GetTelefonoRequest request) {
        try{
            val outputPhone = outputPhonePortFactory.getPhoneOutputPort(request.getDatabase());
