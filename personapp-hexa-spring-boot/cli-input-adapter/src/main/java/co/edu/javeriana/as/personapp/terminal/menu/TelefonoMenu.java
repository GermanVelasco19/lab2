...
public class TelefonoMenu {
    ...
    public void iniciarMenu(TelefonoInputAdapterCli phoneTelefonoInputAdapterCli, Scanner keyboard) {
            ...
            try {
                ...
                switch (opcion) {
                    ...
                    case PERSISTENCIA_MARIADB:
                        phoneTelefonoInputAdapterCli.setPhoneOutputPortInjection("MARIA");
                        menuOpciones(phoneTelefonoInputAdapterCli,keyboard);
                        break;
                    case PERSISTENCIA_MONGODB:
                        phoneTelefonoInputAdapterCli.setPhoneOutputPortInjection("MONGO");
                        menuOpciones(phoneTelefonoInputAdapterCli,keyboard);
                        break;
                    default:
